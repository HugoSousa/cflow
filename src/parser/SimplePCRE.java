...
public class SimplePCRE/* @bgen(jjtree) */implements SimplePCRETreeConstants,
		SimplePCREConstants {/* @bgen(jjtree) */
	protected JJTSimplePCREState jjtree = new JJTSimplePCREState();
	...
	public static void main(String args[]) {
		...
		try {
			SimpleNode n = (new SimplePCRE(System.in)).Start();
			n.dump("");
	...
	final public void ReTail() throws ParseException {
	...
	final public void BasicRe() throws ParseException {
	...
	final public void BasicReTail() throws ParseException {
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ANY:
		case OPEN1:
		case QUOTE:
	...
	final public void SimpleRe() throws ParseException {
		ElementalRe();
		SimpleReTail();
	}

	final public void SimpleReTail() throws ParseException {
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case STAR:
		case PLUS:
		case OPTIONAL:
	...
	final public void ElementalRe() throws ParseException {
		switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
		case ANY:
	...
	final public void Count(SimpleNode parent) throws ParseException {
		jj_consume_token(OPEN2);
		Range(parent);
		jj_consume_token(CLOSE2);
	}

	final public void Range(SimpleNode grandparent) throws ParseException {
		/* @bgen(jjtree) Range */
		...
		try {
			...
			jjtc000 = false;
			if (t2 != null) {
				jjtn000.jjtSetValue(new ElementCounterRange(Integer
						.parseInt(t1.image), Integer.parseInt(t2.image)));
			} else if (hasComma) {
				jjtn000.jjtSetValue(new ElementCounterMinimum(Integer
						.parseInt(t1.image)));
			} else
				jjtn000.jjtSetValue(new ElementCounterExact(Integer
						.parseInt(t1.image)));
		} finally {
			if (jjtc000) {
				jjtree.closeNodeScope(jjtn000, true);
	...
	public SimplePCRETokenManager token_source;
	...
	private static void jj_la1_init_0() {
		jj_la1_0 = new int[] { 0x200, 0x200, 0x46000, 0x11c00, 0x11c00,
				0x46000, 0x10, 0x100, };
	}
